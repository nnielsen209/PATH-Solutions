/**
 * CampersScreen.tsx - Leader Campers View
 *
 * Shows campers from the leader's troop. Read-only view - leaders cannot
 * add or modify campers. Once troop filtering is implemented in the database,
 * this will only show campers from the leader's assigned troop.
 */
...
/**
 * CamperCard - Displays a single camper (view-only)
 */
 ...
 *
 * Shows campers for the leader's troop. Read-only view.
...
export const LeaderCampersScreen = () => {
  ...
  /** Fetch campers from Supabase - TODO: filter by troop */
  const fetchCampers = useCallback(async () => {
    try {
      setError(null);
      setIsLoading(true);

      // TODO: Once troop association is set up, filter campers by the leader's troop:
    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      <View style={[styles.header, isDesktop && styles.headerDesktop]}>
        <View style={[styles.headerInner, isDesktop && styles.headerInnerDesktop]}>
          <Text style={[styles.title, isDesktop && styles.titleDesktop]}>My Campers</Text>
          <Text style={styles.subtitle}>Campers in your troop (view-only)</Text>
        </View>
      </View>
      ...
      {isLoading ? (
        ...
        >
          ...
          <View style={styles.viewOnlyBanner}>
            ...
            <Text style={styles.viewOnlyText}>You have view-only access to camper information</Text>
          </View>
            ...
            <View style={styles.listContent}>
              {campers.length === 0 ? (
                <View style={styles.emptyState}>
                  ...
                  <Text style={styles.emptyStateText}>No campers in your troop</Text>
