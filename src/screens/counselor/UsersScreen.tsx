/**
 * UsersScreen.tsx - Counselor Users Section
 *
 * Single users section for counselors. Placeholder for now; can later show
 * relevant users (e.g. participants in their activities) or contacts.
 */
    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      <View style={[styles.header, isDesktop && styles.headerDesktop]}>
        <View style={[styles.headerInner, isDesktop && styles.headerInnerDesktop]}>
          ...
          <Text style={styles.subtitle}>View users and contacts</Text>
        </View>
      </View>
