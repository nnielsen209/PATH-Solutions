...
const PersonCard = ({ name, initials, subtitle, isLeader, isDesktop, onEdit, onDelete }: PersonCardProps) => {
    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      {isLoading ? (
        ...
        <View style={styles.errorContainer}>
          ...
          <TouchableOpacity style={[styles.retryButton, { backgroundColor: DEV_COLOR }]} onPress={fetchData}>
