/**
 * CampersScreen.tsx - Dev Camper Management
 *
 * Dev-only screen that fetches campers from Supabase.
 * Developers can add campers.
 */
 ...
 *
 * Dev screen for managing campers with add capability.
 */
            ...
            <View style={styles.listHeader}>
              <View style={styles.listTitleRow}>
                ...
                <View style={styles.listTitleBlock}>
                  ...
                  <Text style={styles.listDescription}>Campers from scout table</Text>
                </View>
              ...
              {campers.length === 0 ? (
                <View style={styles.emptyState}>
                  ...
                  <Text style={styles.emptyStateSubtext}>
                    Click "Add Camper" to add a camper
                  </Text>
                </View>
              ) : (
